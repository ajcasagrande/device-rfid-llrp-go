// Code generated by "stringer -type=ParamType,ConnectionAttemptEventType,StatusCode,AirProtocolIDType,VendorIDType,ImpinjModelType,ZebraModelType"; DO NOT EDIT.
...
const (
	_ZebraModelType_name_0 = "FX9600_4"
	_ZebraModelType_name_1 = "FX9600_8"
)

func (i ZebraModelType) String() string {
	switch {
	case i == 96004:
		return _ZebraModelType_name_0
	case i == 96008:
		return _ZebraModelType_name_1
	default:
		return "ZebraModelType(" + strconv.FormatInt(int64(i), 10) + ")"
	}
}
